...
from djangoFinal.blog.views import signup, login_page, logout_page, contact_view, thank_you, NotFoundView, TCView, newsletter_view

urlpatterns = [
    path('admin/', admin.site.urls),
    re_path(r'^ckeditor/', include('ckeditor_uploader.urls')),
    path('', views.IndexView.as_view(), name='index'),
    path('postnewsletter/', newsletter_view, name='postnewsletter'),
