...
from djangoFinal.blog.models import NewsletterEmail, Comment, Contact, Profile, Author, CustomUser


class EmailForm(forms.ModelForm):
    email = forms.CharField(widget=forms.TextInput(
        attrs={'placeholder': 'Enter your email to subscribe...', 'class': 'ml-[25px]'},
    ), label='')
...
class SignupForm(UserCreationForm):
    ...
    class Meta:
        model = CustomUser
        fields = ['first_name', 'last_name', 'username', 'email', 'password1', 'password2', 'is_author']
